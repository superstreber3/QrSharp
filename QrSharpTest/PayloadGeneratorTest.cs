...
public class PayloadGeneratorTest
{
    ...
    public void mail_should_build_type_mailto()
    {
        ...
        generator.ToString()
            .ShouldBe("mailto:john@doe.com?subject=A%20test%20mail&body=Just%20see%20if%20it%20works%21");
    }
    ...
    public void mail_should_build_type_mailto_receiver_only()
    {
        ...
        var generator = new PayloadGenerator.Mail(receiver, encoding: encoding);
    ...
    public void mail_should_escape_input_MATMSG()
    {
        ...
        generator.ToString()
            .ShouldBe("MATMSG:TO:john@doe.com;SUB:A test mail;BODY:Just see if \\\\\\:\\;\\, it works!;;");
    }
    ...
    public void bookmark_should_escape_input()
    {
        ...
        generator.ToString()
            .ShouldBe(
                "MEBKM:TITLE:A nerd's blog\\: \\\\All\\;the\\;things\\\\;URL:http\\://code-bude.net/fake\\,url.html;;");
    }
    ...
    public void girocode_generator_should_throw_iban_exception()
    {
        ...
        var exception = Record.Exception(() => new PayloadGenerator.Girocode(iban, bic, name, amount,
    ...
    public void bezahlcode_generator_can_generate_payload_singlepaymentsepa_minimal()
    {
        ...
        var generator = new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.SinglePaymentSepa,
            name, iban, bic, amount);
    ...
    public void bezahlcode_generator_can_generate_payload_singlepaymentsepa_full()
    {
        ...
        var amount = 10.00m;
        var currency = PayloadGenerator.BezahlCode.Currency.USD;

        var generator = new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.SinglePaymentSepa,
            name, iban, bic, amount, "", 0, null, null, "", "", new DateTime(2017, 03, 01), reason, sepaReference,
    ...
    public void bezahlcode_generator_can_generate_payload_singledirectdebitsepa()
    {
        ...
        var generator = new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.SingleDirectDebitSepa,
            name, iban, bic, amount, "", 0, null, null, creditorId, mandateId, new DateTime(2017, 03, 01), reason,
    ...
    public void bezahlcode_generator_can_generate_payload_periodicsinglepaymentsepa()
    {
        ...
        var generator = new PayloadGenerator.BezahlCode(
            PayloadGenerator.BezahlCode.AuthorityType.PeriodicSinglePaymentSepa, name, iban, bic, amount,
    ...
    public void bezahlcode_generator_can_generate_payload_contact()
    {
        ...
        var generator =
            new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.Contact, name, account, bnc);
    ...
    public void bezahlcode_generator_can_generate_payload_contact_full()
    {
        ...
        var generator = new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.Contact, name,
            account, bnc, "", "", "New business contact.");
    ...
    public void bezahlcode_generator_can_generate_payload_contactv2_classic()
    {
        ...
        var generator =
            new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.ContactV2, name, account, bnc);
    ...
    public void bezahlcode_generator_can_generate_payload_contactv2_sepa()
    {
        ...
        var generator = new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.ContactV2, name,
            iban: iban, bic: bic);
    ...
    public void bezahlcode_generator_should_throw_wrong_contact_v2_constructor_exception()
    {
        ...
        var exception = Record.Exception(() =>
            new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.PeriodicSinglePaymentSepa, name,
                iban: iban, bic: bic));
    ...
    public void bezahlcode_generator_should_throw_wrong_sepa_constructor_periodic_exception()
    {
        ...
        var exception = Record.Exception(() => new PayloadGenerator.BezahlCode(
            PayloadGenerator.BezahlCode.AuthorityType.PeriodicSinglePaymentSepa, name, iban, bic, amount,
            periodicTimeunit, periodicTimeunitRotation, periodicFirstExecutionDate, periodicLastExecutionDate, "", "",
            new DateTime(2017, 03, 01), reason, sepaReference, currency, DateTime.Now));
    ...
    public void bezahlcode_generator_should_throw_name_too_long_exception()
    {
        ...
        var exception = Record.Exception(() =>
            new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.SinglePaymentSepa, name, iban,
                bic, amount));
    ...
    public void bezahlcode_generator_should_throw_separeference_too_long_exception()
    {
        ...
        var exception = Record.Exception(() =>
            new PayloadGenerator.BezahlCode(PayloadGenerator.BezahlCode.AuthorityType.SingleDirectDebitSepa, name, iban,
                bic, amount, "", 0, null, null, creditorId, mandateId, new DateTime(2017, 03, 01), reason,
                sepaReference, currency, DateTime.Now));
    ...
    public void swissQrcode_generator_should_throw_reference_not_allowed()
    {
        ...
        var exception =
            Record.Exception(() => new PayloadGenerator.SwissQrCode.Reference(refType, reference, refTextType));
    ...
    public void swissQrcode_generator_should_throw_unstructured_msg_too_long()
    {
        ...
        var exception = Record.Exception(() =>
            new PayloadGenerator.SwissQrCode.AdditionalInformation(unstructuredMessage, billInformation));

        Assert.NotNull(exception);
        Assert.IsType<PayloadGenerator.SwissQrCode.AdditionalInformation.SwissQrCodeAdditionalInformationException>(
            exception);
        exception.Message.ShouldBe(
    ...
    public void swissQrcode_generator_should_generate_contact_full()
    {
        ...
        var generator =
            PayloadGenerator.SwissQrCode.Contact.WithStructuredAddress(name, zip, city, country, street, houseNumber);
    ...
    {
        var creditor =
            PayloadGenerator.SwissQrCode.Contact.WithStructuredAddress("John Doe", "3003", "Bern", "CH",
                "Parlamentsgebäude", "1");
        var iban = new PayloadGenerator.SwissQrCode.Iban("CH2430043000000789012",
            PayloadGenerator.SwissQrCode.Iban.IbanType.QrIban);
        var reference = new PayloadGenerator.SwissQrCode.Reference(
            PayloadGenerator.SwissQrCode.Reference.ReferenceType.QRR, "990005000000000320071012303",
            PayloadGenerator.SwissQrCode.Reference.ReferenceTextType.QrReference);
    ...
    public void swissQrcode_generator_should_generate_swisscode_full()
    {
        ...
        var additionalInformation =
            new PayloadGenerator.SwissQrCode.AdditionalInformation("This is my unstructured message.",
    ...
    public void swissQrcode_generator_should_not_generate_space_as_thousands_separator()
    {
        var contactGeneral =
            PayloadGenerator.SwissQrCode.Contact.WithStructuredAddress("John Doe", "3003", "Bern", "CH",
                "Parlamentsgebäude", "1");
        var iban = new PayloadGenerator.SwissQrCode.Iban("CH2609000000857666015",
            PayloadGenerator.SwissQrCode.Iban.IbanType.Iban);
        var reference = new PayloadGenerator.SwissQrCode.Reference(
            PayloadGenerator.SwissQrCode.Reference.ReferenceType.SCOR, "99000500000000032003",
            PayloadGenerator.SwissQrCode.Reference.ReferenceTextType.CreditorReferenceIso11649);
        var currency = PayloadGenerator.SwissQrCode.Currency.CHF;
        var additionalInformation =
            new PayloadGenerator.SwissQrCode.AdditionalInformation("This is my unstructured message.",
                "Some bill information here...");
    ...
    public void swissQrcode_generator_should_throw_amount_too_big()
    {
        ...
        var exception = Record.Exception(() => new PayloadGenerator.SwissQrCode(iban, currency, contactGeneral,
            reference, additionalInformation, contactGeneral, amount, reqDateOfPayment, contactGeneral));
    ...
    public void swissQrcode_generator_should_throw_incompatible_reftype()
    {
        ...
        var iban = new PayloadGenerator.SwissQrCode.Iban("CH2430043000000789012",
            PayloadGenerator.SwissQrCode.Iban.IbanType.QrIban);
        var reference =
            new PayloadGenerator.SwissQrCode.Reference(PayloadGenerator.SwissQrCode.Reference.ReferenceType.NON);
        var additionalInformation =
            new PayloadGenerator.SwissQrCode.AdditionalInformation("This is my unstructured message.",
                "Some bill information here...");
        var currency = PayloadGenerator.SwissQrCode.Currency.CHF;
    ...
    public void swissQrcode_generator_should_throw_alt1_too_long()
    {
        ...
        var iban = new PayloadGenerator.SwissQrCode.Iban("CH2430043000000789012",
            PayloadGenerator.SwissQrCode.Iban.IbanType.QrIban);
        var reference =
            new PayloadGenerator.SwissQrCode.Reference(PayloadGenerator.SwissQrCode.Reference.ReferenceType.QRR);
        var additionalInformation =
            new PayloadGenerator.SwissQrCode.AdditionalInformation("This is my unstructured message.",
                "Some bill information here...");
        var currency = PayloadGenerator.SwissQrCode.Currency.CHF;
        ...
        var exception = Record.Exception(() => new PayloadGenerator.SwissQrCode(iban, currency, contactGeneral,
            reference, additionalInformation, contactGeneral, amount, reqDateOfPayment, contactGeneral, alt1));
    ...
    public void swissQrcode_generator_should_throw_alt2_too_long()
    {
        ...
        var alt2 =
            "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
        var exception = Record.Exception(() => new PayloadGenerator.SwissQrCode(iban, currency, contactGeneral,
            reference, additionalInformation, contactGeneral, amount, reqDateOfPayment, contactGeneral, alt1, alt2));
    ...
    public void contactdata_generator_can_generate_payload_full_mecard()
    {
        ...
        var generator = new PayloadGenerator.ContactData(outputType, firstname, lastname, nickname, phone, mobilePhone,
            workPhone, email, birthday, website, street, houseNumber, city, zipCode, country, note, org: org,
            orgTitle: orgTitle);
    ...
    public void contactdata_generator_can_generate_payload_full_mecard_reversed()
    {
        ...
        var generator = new PayloadGenerator.ContactData(outputType, firstname, lastname, nickname, phone, mobilePhone,
            workPhone, email, birthday, website, street, houseNumber, city, zipCode, country, note,
            addressOrder: PayloadGenerator.ContactData.AddressOrder.Reversed, org: org, orgTitle: orgTitle);
    ...
    public void russiapayment_generator_can_generate_payload_mandatory_fields()
    {
        ...
        generator
            .ToString()
            .ShouldBe(
                $"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|");
    }
    ...
    public void russiapayment_generator_can_generate_payload_encoding_win1251()
    {
        ...
        var name = "ООО «Три кита»";
        var correspAcc = "30101810965770000413";
        var generator = new PayloadGenerator.RussiaPaymentOrder(name, account, bankName, bic, correspAcc, null,
            PayloadGenerator.RussiaPaymentOrder.CharacterSets.windows_1251);

        byte[] targetBytes =
        {
            83, 84, 48, 48, 48, 49, 49, 124, 78, 97, 109, 101, 61, 206, 206, 206, 32, 171, 210, 240, 232, 32, 234, 232,
            242, 224, 187, 124, 80, 101, 114, 115, 111, 110, 97, 108, 65, 99, 99, 61, 52, 48, 55, 48, 50, 56, 49, 48,
            49, 51, 56, 50, 53, 48, 49, 50, 51, 48, 49, 55, 124, 66, 97, 110, 107, 78, 97, 109, 101, 61, 206, 192, 206,
            32, 34, 193, 192, 205, 202, 34, 124, 66, 73, 67, 61, 48, 52, 52, 53, 50, 53, 50, 50, 53, 124, 67, 111, 114,
            114, 101, 115, 112, 65, 99, 99, 61, 51, 48, 49, 48, 49, 56, 49, 48, 57, 54, 53, 55, 55, 48, 48, 48, 48, 52,
            49, 51, 124
        };
        var payloadBytes = generator.ToBytes();

        Assert.True(targetBytes.Length == payloadBytes.Length,
            $"Byte array lengths different. Expected: {targetBytes.Length}, Actual: {payloadBytes.Length}");
    ...
    public void russiapayment_generator_can_generate_payload_encoding_koi8()
    {
        ...
        var correspAcc = "30101810965770000413";
        var generator = new PayloadGenerator.RussiaPaymentOrder(name, account, bankName, bic, correspAcc, null,
            PayloadGenerator.RussiaPaymentOrder.CharacterSets.koi8_r);

        byte[] targetBytes =
        {
            83, 84, 48, 48, 48, 49, 51, 124, 78, 97, 109, 101, 61, 239, 239, 239, 32, 60, 244, 210, 201, 32, 203, 201,
            212, 193, 62, 124, 80, 101, 114, 115, 111, 110, 97, 108, 65, 99, 99, 61, 52, 48, 55, 48, 50, 56, 49, 48, 49,
            51, 56, 50, 53, 48, 49, 50, 51, 48, 49, 55, 124, 66, 97, 110, 107, 78, 97, 109, 101, 61, 239, 225, 239, 32,
            34, 226, 225, 238, 235, 34, 124, 66, 73, 67, 61, 48, 52, 52, 53, 50, 53, 50, 50, 53, 124, 67, 111, 114, 114,
            101, 115, 112, 65, 99, 99, 61, 51, 48, 49, 48, 49, 56, 49, 48, 57, 54, 53, 55, 55, 48, 48, 48, 48, 52, 49,
            51, 124
        };
        var payloadBytes = generator.ToBytes();
    ...
    public void russiapayment_generator_should_throw_data_too_long_exception()
    {
        ...
        var bankName = "ОАО | \"БАНК\"";
        var name =
            "A very very very very very very very very very very very very very very very very very very very very very very very very very very very very very long name";
        var correspAcc = "30101810400000000225";
        ...
        var generator =
            new PayloadGenerator.RussiaPaymentOrder(name, account, bankName, bic, correspAcc, optionalFields);
    ...
    public void russiapayment_generator_should_throw_must_not_be_null_exception()
    {
        ...
        var exception = Record.Exception(() =>
            new PayloadGenerator.RussiaPaymentOrder(name, account, bankName, bic, correspAcc));
        Assert.NotNull(exception);
        Assert.IsType<PayloadGenerator.RussiaPaymentOrder.RussiaPaymentOrderException>(exception);
    ...
    public void russiapayment_generator_can_generate_payload_some_additional_fields()
    {
        ...
        generator
            .ToString()
            .ShouldBe(
                $"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|Sum={optionalFields.Sum}|LastName={optionalFields.LastName}|FirstName={optionalFields.FirstName}|");
    }
    ...
    public void russiapayment_generator_can_generate_payload_all_additional_fields_pt1()
    {
        ...
        generator
            .ToString()
            .ShouldBe(
                $"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|Sum={optionalFields.Sum}|CBC=CBC1|LastName=Hann|FirstName=R|MiddleName=C|Contract=99|ChildFio=J Doe|BirthDate=01.01.1990|Category=1|ClassNum=1|AddAmount=10|");
    }
    ...
    public void russiapayment_generator_can_generate_payload_all_additional_fields_pt2()
    {
        ...
        generator
            .ToString()
            .ShouldBe(
                $"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|DrawerStatus=D1|KPP=KPP1|OKTMO=112233|DocNo=11|DocDate=08.11.2021|DocIdx=A1|Flat=5a|CounterId=1234|CounterVal=9999|InstNum=987|ExecId=77|");
    }
    ...
    public void russiapayment_generator_can_generate_payload_all_additional_fields_pt3()
    {
        ...
        generator
            .ToString()
            .ShouldBe(
                $"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|PayeeINN=INN1|PayerINN=INN2|PaytReason=01|PayerAddress=Street 1, 123 City|PensAcc=SNILS_NO|PayerIdType=X|PayerIdNum=555|PaymTerm=A|PaymPeriod=12|");
    }
    ...
    public void russiapayment_generator_can_generate_payload_all_additional_fields_pt4()
    {
        ...
        generator
            .ToString()
            .ShouldBe(
                $"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|Purpose=Test|PersonalAccount=3333|PersAcc=2222|Phone=0012345|ServiceName=Bank|QuittId=7|QuittDate=01.02.2021|RuleId=2|RegType=y|");
    }
    ...
    public void russiapayment_generator_can_generate_payload_all_additional_fields_pt5()
    {
        ...
        generator
            .ToString()
            .ShouldBe(
                $"ST00012|Name={name}|PersonalAcc={account}|BankName={bankName}|BIC={bic}|CorrespAcc={correspAcc}|TaxPeriod=31|TaxPaytKind=99|SpecFio=T. Eacher|UIN=1a2b|TechCode=ГИБДД_налоги_пошлины_бюджетные_платежи|");
    }
}