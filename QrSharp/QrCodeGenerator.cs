...
{
    /// <summary>
    ///     Error correction level. These define the tolerance levels for how much of the code can be lost before the code
    ///     cannot be recovered.
    /// </summary>
    ...
    /// <summary>
    ///     Calculates the Qr code data which than can be used in one of the rendering classes to generate a graphical
    ///     representation.
    /// </summary>
    /// <param name="payload">A payload object, generated by the PayloadGenerator-class</param>
    /// <exception cref="DataTooLongException">
    ///     Thrown when the payload is too big to be encoded in a Qr
    ///     code.
    /// </exception>
    ...
    private static EncodingMode GetEncodingFromPlaintext(string plainText, bool forceUtf8)
    {
        ...
        foreach (var c in plainText.Where(c => !IsInRange(c, '0', '9')))
        {
            ...
            hasAlphanumeric = true; // alphanumeric
        }
