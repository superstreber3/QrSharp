...
public sealed class PngByteQrCode : AbstractQrCode, IDisposable
{
    ...
    /// <summary>
    ///     Creates a black & white PNG of the Qr code, using 1-bit gray scale.
    /// </summary>
    ...
    /// <summary>
    ///     Creates 2-color PNG of the Qr code, using 1-bit indexed color. Accepts 3-byte RGB colors for normal images and
    ///     4-byte RGBA-colors for transparent images.
    /// </summary>
    ...
    private byte[] DrawScanlines(int pixelsPerModule, bool drawQuietZones)
    {
        ...
        var bytesPerScanline =
            ...
            1; // A monochrome scanline is one byte for filter type then one bit per pixel.
